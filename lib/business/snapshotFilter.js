...
const { frequencyPriorities }  = require('../constants')
...
const filterOverdueStatuesByPriorities = overdueStatuses => {
...
const getOverdueStatuses = (date, zmanConfig, snapshots) => {
  ...
  return filterOverdueStatuesByPriorities(overdueStatuses)
}
