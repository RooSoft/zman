...
const displayStatus = ({ configFilePath, poolName, frequency }) => {
  const { activeSnapshots, expiredSnapshots, overdueStatuses } = analyzeZfsPool({ configFilePath, poolName, frequency })
